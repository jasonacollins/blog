...
A common recommendation for an addition to my [evolution and economics reading list](economics_and_evolutionary_biology_reading_list.md) is Matt Ridley's *The Rational Optimist: How Prosperity Evolves*. These thoughts are designed, in part, to explain why I don't plan to add it.
...
Ultimately, I also take Ridley's plea for optimism with a grain of salt. Contrast Ridley's plea for optimism to Julian Simon's suggestion that it is [worry that actually delivers the benefits](would-julian-simon-worry.md).
