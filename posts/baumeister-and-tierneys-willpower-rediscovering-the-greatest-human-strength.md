...
After the [recent hullabaloo about whether ego depletion was a real phenomenon](failure-to-replicate-ego-depletion-edition.md), I decided to finally read Roy Baumeister and John Tierney's *Willpower* cover to cover (I've only flicked through it before).
