...
I first wrote [a version of this post in April 2023](using-large-language-models-as-academic.qmd). A lot has changed since then in both the tools and how I use them.
