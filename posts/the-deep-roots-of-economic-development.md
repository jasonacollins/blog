...
I am going to cover the article over two posts. This first post covers the major theme of the first half of the paper - that it is populations, not institutions, that underlie persistent differences in economic development. In [a second post](the-intergenerational-transmission-of-economic-development.md), I comment on Spolaore and Wacziarg's analysis of the genetic and cultural intergenerational transmission of development.
...
In [my next post](the-intergenerational-transmission-of-economic-development.md), I address the intergenerational transmission of traits. And I've added Spolaore and Wacziarg's paper to my [evolutionary biology and economics reading list](economics_and_evolutionary_biology_reading_list.md).
