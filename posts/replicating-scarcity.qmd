...
In [*Scarcity: Why having too little means so much*](/posts/scarcity-of-time-money-friends-and-bandwidth.md), Sendhil Mullainathan and Eldar Shafir tell the following (now famous) story:
...
It fails the ["effect is too large" heuristic](/posts/the-effect-is-too-large-heuristic.md). This can't be anything but a massively biased effect size.
