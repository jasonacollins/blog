...
In my previous posts on loss aversion ([here](kahneman-and-tverskys-debatable-loss-aversion-assumption.md), [here](what-can-we-infer-about-someone-who-rejects-a-5050-bet-to-win-110-or-lose-100-the-rabin-paradox-explored.qmd) and [here](the-case-against-loss-aversion.md)), I foreshadowed a post on how "ergodicity economics" might shed some light on whether we need loss aversion to explain people's choices under uncertainty. This was to be that post, but the background material that I drafted is long enough to be a stand-alone piece. I'll turn to the application of ergodicity economics to loss aversion in a future post.
...
In my [next post on this topic](risk-and-loss-aversion-in-ergodicity-economics.qmd) I ask whether, given the above, we need risk and loss aversion to explain our choices.
