...
One effective filter for junk results is the ["effect size is too large" heuristic](/posts/the-effect-is-too-large-heuristic.md). Is the effect size reasonable given the intervention?
...
Ultimately, I wouldn't rule this effect size out in the way I do with the ["hungry judges"](/posts/the-effect-is-too-large-heuristic.md). But I still think that, to the extent the effect exists, it is much smaller than the the estimated effect size.
...
I feel that's a bit like stating that [the average effect size of a nudge is 0.43](/posts/how-big-is-the-effect-of-a-nudge.md). Across the huge body of interventions that might be called nudges and the growing literature on habituation to nudges, this blanket statement based on a single study seems to be gross overreach.
